...
class Messager:
    ...
    def send_message(self, text_content):
        ...
        try:
            ...
            content = '[聚宽diff] ' + current_time + text_content
...
def get_priority_list(context, hl_list,date):
    ...
    messager.send_message('可能买入股票：%s '% str([get_security_info(stock).display_name for stock in qualified_stocks]))
    ...
    if len(qualified_stocks) != 0 and context.portfolio.available_cash / context.portfolio.total_value > 0.3:
        ...
        for s in qualified_stocks:
            ...
            if context.portfolio.available_cash / current_data[s].last_price > 100:
                ...
                print('买入' + s)
                messager.send_message('买入' + s + '，名称：' + get_security_info(s).display_name)
                print('———————————————————————————————————')
